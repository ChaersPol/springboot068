...
## 本项目获取地址：https://www.bishecode.com/product/65/
...
图5.1 用户信息管理界面【桂林旅游景点导游平台的系统管理员可以管理用户，可以对用户信息添加修改删除以及查询操作。具体界面的展示如图】
![alt text](images/image-3.png)

图5.2 景点类型管理界面【系统管理员可以查看对景点类型进行添加，修改，删除以及查询操作。具体界面如图】
![alt text](images/image-4.png)

图5.3 景点信息管理界面【系统管理员可以对景点信息进行添加，修改，删除以及查询操作。界面如下图所示】
![alt text](images/image-5.png)

图5.4 线路推荐管理界面【系统管理员可以对线路推荐进行添加修改删除操作。界面如下图所示】
